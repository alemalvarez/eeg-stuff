...
from params.shannon_entropy import calcular_se as shannon_entropy_psd
from params.tsallis_entropy import calcular_te as tsallis_entropy_psd
from params.renyi_entropy import calcular_re as renyi_entropy_psd
...
class TestShannonEntropyPSD:
    ...
    def test_additivity_independent_signals(self):
        ...
        combined_signal = combined_signal.reshape(1, len(combined_signal), 1)
    ...
    def test_concavity_property(self):
        ...
        entropy1 = shannon_entropy_psd(psd1, f1, DEFAULT_BAND)
        entropy2 = shannon_entropy_psd(psd2, f2, DEFAULT_BAND)
        entropy_mixed = shannon_entropy_psd(mixed_psd, f_combined, DEFAULT_BAND)
