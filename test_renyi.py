...
from eeg_utils import get_spectral_density
from renyi_entropy import calcular_re
...
class TestCalcularRE:
    ...
    def test_invalid_q_parameter(self, uniform_psd):
        ...
        result = calcular_re(psd, f, banda, q_param=1.0001)
    ...
    def test_empty_band(self, uniform_psd):
        ...
        banda = [40.0, 10.0]
        result = calcular_re(psd, f, banda, q_param=2.0)
        assert result is None, "Invalid band should return None"
